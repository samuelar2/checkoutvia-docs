...
<ResponseField name="subject" type="string">
  Your own id for the end user this profile *is*. Optional, max 200 characters, opaque to us,
  ...
  `PATCH` with `subject` is a `400`, not a silent no-op. Decide before you create.
</ResponseField>
...
ship to another's profile, and cannot list them either. See
